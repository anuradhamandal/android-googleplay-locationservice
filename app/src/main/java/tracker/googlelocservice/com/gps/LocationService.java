...
public class LocationService extends Service implements
    ...
    protected static final String TAG = "location-updates-service";
...
//        getApplicationContext().stopService(new Intent(getApplicationContext(), LocationService.class));
    ...
    public void onStart(Intent intent, int startId) {
        Toast.makeText(getApplicationContext(), "Location Service is running", Toast.LENGTH_SHORT).show();
...
//            updateUI();
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.d(TAG, String.valueOf(mCurrentLocation.getProvider()));
    }
